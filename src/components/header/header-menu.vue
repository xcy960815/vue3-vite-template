    ...
    >
      <template v-for="menu in menus" :key="menu.key">
        ...
        >
          ...
          <template v-for="childrenMenu in menu.children" :key="childrenMenu.key">
            <el-submenu
              ...
              >
                <el-menu-item :index="childrenMenuItem.key">
                  <a
                    ...
                    rel="noopener"
                    style="display: block; padding: 0 20px; text-decoration: none; color: inherit"
                    target="_blank"
                    class="menu-trigger"
...
import { defineComponent, ref, Ref, onMounted, reactive, toRefs, onUnmounted } from 'vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const generateMenus = () => {
      // 获取header-menu的全部宽度
      const menuWrapWidth = (refHeaderMenu.value as HTMLDivElement).getBoundingClientRect().width
